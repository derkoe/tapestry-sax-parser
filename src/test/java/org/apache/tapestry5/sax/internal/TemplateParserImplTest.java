...
public class TemplateParserImplTest extends InternalBaseTestCase
{
    ...
    {
        return this.getService("TemplateParserOverride", TemplateParser.class);
    }
    ...
    public Object[][] parse_failure_data()
    {
        return new Object[][] {
                ...
                { "parameter_namespace_with_attributes.tml",
                        SaxParserMessages.parameterElementDoesNotAllowAttributes(), 4 },
    ...
    public Object[][] doctype_token_added_correctly_data()
    {
        return new Object[][] {
                ...
                { "system_doctype.xml", "foo", null,
                        "src/test/resources/org/apache/tapestry5/sax/internal/simple.dtd" } };
    }
    ...
    {
        System.setProperty("user.dir", MODULE_BASE_DIR_PATH);
